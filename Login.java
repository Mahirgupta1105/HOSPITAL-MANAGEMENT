...
<<<<<<< HEAD
			...
			if(rs.next()) {
				...
				if (storedHash.contains(":")) {
					...
					passwordMatches = PasswordUtil.verify(pwd, storedHash);
				} else {
					// Legacy plain text password (for backwards compatibility)
					passwordMatches = storedHash.equals(pwd);
				}
				...
				if (passwordMatches) {
					...
					out.println("<br><br><br><h1 align=center><font color=\"red\">INVALID PASSWORD<br>REDIRECTING YOU TO LOGIN PAGE</font></h1><script type=\"text/javascript\">");  
				...
				// User not found
				response.setContentType("text/html");  
				out.println("<br><br><br><h1 align=center><font color=\"red\">USER NOT FOUND<br>REDIRECTING YOU TO LOGIN PAGE</font></h1><script type=\"text/javascript\">");  
				out.println("redirectURL = \"login.html\";setTimeout(\"location.href = redirectURL;\",\"5000\");");  
				out.println("</script>");
			}
=======
