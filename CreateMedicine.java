...
public class CreateMedicine extends HttpServlet {
	...
	// Validate inputs
	ValidationUtils.ValidationResult nameResult = ValidationUtils.validateNotEmpty(name, "Medicine name");
	...
	ValidationUtils.ValidationResult priceResult = ValidationUtils.validatePositiveNumber(price, "Price");
	if (!priceResult.isValid()) {
		response.setContentType("text/html");  
		out.println("<br><br><br><h1 align=center><font color=\"red\">" + priceResult.getErrorMessage() + "</font></h1>");
		return;
	}
	
	ValidationUtils.ValidationResult countResult = ValidationUtils.validatePositiveNumber(count, "Count");
	if (!countResult.isValid()) {
		response.setContentType("text/html");  
		out.println("<br><br><br><h1 align=center><font color=\"red\">" + countResult.getErrorMessage() + "</font></h1>");
		return;
	}
